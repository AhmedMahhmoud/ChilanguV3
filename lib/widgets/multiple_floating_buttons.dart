...
class MultipleFloatingButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Consumer<PermissionHan>(
        builder: (context, value, _) {
          return Visibility(
              visible: !value.isUserScrolling,
              child: FadeIn(
                  child: SpeedDial(
                    overlayOpacity: 0,
                    ...
                    children: [
                      ...
                      SpeedDialChild(
                          ...
                          backgroundColor: ColorManager.primary,
                          onTap: () {
                            goPage(context, const NavScreenTwo(3));
                          },
                      ...
                      SpeedDialChild(
                          ...
                          backgroundColor: ColorManager.primary,
                          onTap: () {
                            goPage(context, const NavScreenTwo(2));
                          },
                      ...
                      SpeedDialChild(
                          ...
                          backgroundColor: ColorManager.primary,
                          onTap: () {
                            goPage(context, const NavScreenTwo(1));
                          },
                      ...
                      SpeedDialChild(
                          ...
                          backgroundColor: ColorManager.primary,
                          onTap: () {
                            goPage(context, const NavScreenTwo(0));
                          },
...
class MultipleFloatingButtonsNoADD extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<PermissionHan>(builder: (context, snapshot, _) {
      return Visibility(
        visible: !snapshot.isUserScrolling,
        child: Padding(

...
class DataTableMissionHeaderForUser extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Directionality(
      textDirection: ui.TextDirection.rtl,
      child: Row(
        children: [
          ...
          DataTableHeaderTitlesForUser(
              "       " + getTranslated(context, "إلى"), ColorManager.primary),
          DataTableHeaderTitlesForUser(
              getTranslated(context, "الموقع"), ColorManager.primary),
          DataTableHeaderTitlesForUser(
              getTranslated(context, "المناوبة"), ColorManager.primary),
        ],
      ),
    );
  }

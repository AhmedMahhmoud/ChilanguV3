...
class DataTableHeaderTitles extends StatelessWidget {
  final String title;
  final Color color;
  const DataTableHeaderTitles(this.title, this.color);
  @override
  Widget build(BuildContext context) {
    return Expanded(
      flex: 4,
...
class DataTableHeaderTitlesForUser extends StatelessWidget {
  final String title;
  final Color color;
  const DataTableHeaderTitlesForUser(this.title, this.color);
  @override
  Widget build(BuildContext context) {
    return Expanded(
      child: Center(

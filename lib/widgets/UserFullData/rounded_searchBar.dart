                              ...
                              builder: (context, shiftData, child) {
                                return IgnorePointer(
                                  ...
                                  child: DropdownButton(
                                          ...
                                          Provider.of<MemberData>(context,
                                              ...
                                              .getAllCompanyMember(
                                                  ...
                                                  Provider.of<UserData>(context,
                                                      ...
                                                      .userToken,
                                                  context,
                                                  shiftData.shifts[holder].shiftId == -100
                                                      ? -1
                                      ...
                                      hint: Provider.of<SiteShiftsData>(context,
                                                      listen: false)
                                                  .shifts
                                                  .isEmpty &&
                          ...
                          onTap: () {
                            if (widget.textController.text.length < 3) {
                              Fluttertoast.showToast(
                                  msg: getTranslated(
                                      context, "يجب ان لا يقل البحث عن 3 احرف"),

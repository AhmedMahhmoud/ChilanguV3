                            ...
                            builder: (context, value, child) {
                              return DropdownButton(
                                ...
                                items: widget.list
                                    ...
                                    .toList(),
                                onChanged: (v) async {
                                  widget.prov.setDropDownShift(0, true);
                                  Provider.of<SiteShiftsData>(context,
                                          listen: false)
                                      .getShiftsList(v, false);
                                  if (v != "كل المواقع") {
                                    widget.prov.setDropDownIndex(
                                        widget.prov.dropDownSitesStrings
                                                .indexOf(v) -
                                            1,
                                        true);
                                  } else {
                                    widget.prov.setDropDownIndex(0, true);
                                  }

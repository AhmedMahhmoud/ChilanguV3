...
class _DisplayHolidaysState extends State<DisplayHolidays> {
  ...
  Widget build(BuildContext context) {
    final holidayProv = Provider.of<UserHolidaysData>(context, listen: true);
      ...
      child: Column(
        children: [
          ...
          widget._nameController.text == "" ||
              ...
              ? Container()
              : ZoomIn(
                  child: Divider(thickness: 1, color: ColorManager.primary)),
          widget._nameController.text == "" ||
                  holidayProv.singleUserHoliday.isEmpty
              ? Container()
              : SlideInUp(child: HolidaySummaryTableEnd())
        ],
      ),
    );
  }

...
class MemberData with ChangeNotifier {
  ...
  Future<void> searchUsersList(String filter, String userToken, dynamic siteId,
    ...
    if (decodedRes["message"] == "Success") {
      final memberObjJson = jsonDecode(response)['data'] as List;
  ...
  Future<bool> allowMemberAttendByCard(
    ...
    try {
      ...
      if (decodedResponse["message"] == "Success : User Updated!") return true;
      return false;
    } catch (e) {
      log(e);
    }
  ...
  Future<bool> exludeUserFromReport(
      String userID, bool allowValue, String userToken) async {
    try {

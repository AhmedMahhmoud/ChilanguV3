...
class _LoginScreenState extends State<LoginScreen> {
  ...
  checkPrivacyPolicy() async {
    ...
    final bool privacyBool = sharedPreferences.getBool('appPolicy') ?? false;
    if (!privacyBool) {
                    ...
                    ? Padding(
                        ...
                        child: Container(
                          child: InkWell(
                            onTap: () {
                              launch(
                                  'https://chilango.tamauzeds.com/ChilangoPrivacyPolicy.html');
                            },
                            child: AutoSizeText.rich(TextSpan(
                                text: getTranslated(context,
                                    'باستخدام chilango فإنك توافق على'),
                                children: [
                                  TextSpan(
                                      text: getTranslated(
                                          context, 'سياسة الخصوصية'),

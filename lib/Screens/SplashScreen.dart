...
import 'AdminPanel/pending_company_permessions.dart';
import 'AdminPanel/pending_company_vacations.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  bool _visible = false;
  bool _isNotificationCached = false;
  ...
  reverse(String userName, value) async {
        ...
        if (userName != "") {
          if (Provider.of<UserData>(context, listen: false).changedPassword ==
            ...
            if (value == USER_INVALID_RESPONSE || value == null) {
              ...
              if (_isNotificationCached == false) {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const SuperCompanyPieChart(false),
                    ));
              }

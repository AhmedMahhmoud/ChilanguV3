...
class ExpandedPendingVacation extends StatefulWidget {
  ...
  final List<GlobalKey<ExpansionTileCardState>> cardList;
            ...
            if (value) {
              ...
              Future.delayed(const Duration(milliseconds: 0), () {
                for (var i = 0; i < widget.cardList.length; i++) {
                  if (widget.index != i) {
                    widget.cardList[i].currentState?.collapse();
                  }
                }
              });
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            width: 90.w,
                            child: AutoSizeText(
                              getVacationType(widget.userHolidays.holidayType),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Divider(),
                              AutoSizeText(
                                "${getTranslated(context, "نوع الأجازة ")}: ${getVacationType(widget.userHolidays.holidayType)} ",
                                style: TextStyle(
                                  fontSize: setResponsiveFontSize(14),
                                  fontWeight: FontWeight.w500,
                                ),

                      ...
                      children: [
                        ...
                        ServiceTile(
                            ...
                            onTap: () async {
                              ...
                              userProvider.user.userType == 2
                                  ...
                                  : goPage(
                                      context, const ShiftsScreen(0, -1, 0));
                            }),
                        ServiceTile(
                            ...
                            onTap: () async {
                              if (userProvider.user.userType == 2) {
                                ...
                                siteProv.setDropDownShift(0, false);
                                // ignore: cascade_invocations
                                siteProv.setDropDownIndex(
                                    userDataProvider.user.userSiteId, false);
                                goPage(
                                    context,
                                    SiteAdminUserScreen(
                        ...
                        userProvider.user.userType == 2
                            ...
                            : ServiceTile(
                                ...
                                icon: Icons.settings,
                                onTap: () async {
                                  goPage(context, CompanySettings());
                                }),
                        // ServiceTile(
...
class ServiceTile extends StatelessWidget {
  ...
  final icon;
  final onTap;
  const ServiceTile({this.title, this.subTitle, this.icon, this.onTap});

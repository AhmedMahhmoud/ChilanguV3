...
class _ReAllocateUsersState extends State<ReAllocateUsers> {
  ...
  var _fromDate;
  DateTime yesterday;
  final DateTime inititalDate = DateTime.now();
                                                  ...
                                                  onSubmit: (date) {
                                                    ...
                                                    changeState(() {
                                                      ...
                                                      final String fromText =
                                                          " ${getTranslated(context, "من")} ${DateFormat('yMMMd').format(_fromDate).toString()}";
                                                      final String toText =
                                                          " ${getTranslated(context, "إلى")} ${DateFormat('yMMMd').format(_toDate).toString()}";
                                                      newString =
                                                          "$fromText $toText";
                                                    });
                                                                                    ...
                                                                                    return DropdownButton(
                                                                                        ...
                                                                                        onChanged: (v) async {
                                                                                          ...
                                                                                          if (selectedVal != "كل المواقع") {
                                                                                            ...
                                                                                            holder = x.indexOf(v);
                                                                                            setState(() {
                                                                                              prov.setDropDownShift(holder, true);
                                                                                            });
                                                                                    ...
                                                                                    return DropdownButton(
                                                                                      ...
                                                                                      onChanged: (v) async {
                                                                                        prov
                                                                                          ...
                                                                                          ..setDropDownIndex(prov.dropDownSitesStrings.indexOf(v) - 1, true);
                                    ...
                                    if (widget.isEdit) {
                                      ...
                                      if (msg == "Success") {
                                        ...
                                        Fluttertoast.showToast(
                                            ...
                                            backgroundColor: Colors.red);
                                      } else if (msg == "missionExists") {
                                        displayErrorToast(context,
                                            "خطأ : المستخدم لة مأمورية فى تلك الفترة");
                                      } else if (msg == "error") {
                                        errorToast(context);
                                      } else {

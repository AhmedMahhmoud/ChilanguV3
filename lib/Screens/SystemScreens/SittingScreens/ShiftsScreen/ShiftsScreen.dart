...
class _ShiftsScreenState extends State<ShiftsScreen> {
  ...
  void didChangeDependencies() async {
    ...
    // await getData();
    if (mounted) print("site id :$siteId");
                                                      ...
                                                      itemBuilder:
                                                        ...
                                                        return ShiftTile(
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return RoundedAlert(
                                                                      onPressed:
                                                                        ...
                                                                        if (msg ==
                                                                            "Success") {
                                                                          log(Provider.of<SiteShiftsData>(context, listen: false)
                                                                              .siteShiftList[widget.siteIndex]
                                                                              .siteName);
                                                                          Provider.of<SiteShiftsData>(context, listen: false).getShiftsList(
                                                                              Provider.of<SiteShiftsData>(context, listen: false).siteShiftList[siteId].siteName,
                                                                              false);
                                                          ...
                                                          onTapEdit: () async {
                                                            ...
                                                            currentShift = await Provider.of<
                                                                        ShiftApi>(
                                                                    context,
                                                                    listen:
                                                                        false)

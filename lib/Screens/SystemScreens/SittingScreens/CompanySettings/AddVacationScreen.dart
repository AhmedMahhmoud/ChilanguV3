...
class AddVacationScreen extends StatefulWidget {
  ...
  AddVacationScreen({this.edit, this.vacation});
  @override
...
class _AddVacationScreenState extends State<AddVacationScreen> {
  ...
  void initState() {
    ...
    if (widget.edit) {
      selectedDate = widget.vacation.vacationDate;
      selectedDateString = widget.vacation.vacationDate.toString();
    }
    ...
    if (widget.edit) {
      _nameController.text = widget.vacation.vacationName;
    }
  }

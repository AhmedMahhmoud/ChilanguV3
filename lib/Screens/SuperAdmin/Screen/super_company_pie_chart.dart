...
class SuperCompanyPieChart extends StatefulWidget {
  ...
  const SuperCompanyPieChart(this.comingFromAdminPanel);
  @override
...
class _SuperCompanyPieChartState extends State<SuperCompanyPieChart> {
  ...
  Widget build(BuildContext context) {
    final comData = Provider.of<CompanyData>(context);

    SystemChrome.setEnabledSystemUIOverlays([]);
    return Consumer<UserData>(builder: (context, userData, child) {
      return GestureDetector(
        onTap: () {
          print(comData.com.logo);
        },
        child: Scaffold(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: [
                                    SinglePieChartItem(
                                      ...
                                      color: ColorManager.googleGreen,
                                      count: userData
                                ...
                                if (!userData
                                  ...
                                  SinglePieChartItem(
                                    ...
                                    color: ColorManager.googleYellow,
                                    count: userData
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        if (userData.isTechnicalSupport) {
                          debugPrint(
                              "overiding tech supporrt rule from 4 to 3");
                          Provider.of<UserData>(context, listen: false)
                              .user
                              .userType = 3;
                        }
                        //  onPressed: () {
                        if (widget.comingFromAdminPanel) {
                          Navigator.pop(context);
                        } else {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const NavScreenTwo(
                                  2,
                                ),
                              ));
                        }

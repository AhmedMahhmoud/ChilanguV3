...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String encryptUserName(String userName) {
    var output = new List(50);
    log("Encrypting $userName");
    const String encCode = "@QnhU64!z&9#Ke84hfogueb748%H&*@DghJ!kwfJLp&@A3z%s7";
    ...
    for (int i = 0; i < cUserId.length; i++) {
      output[i] =
          String.fromCharCode(cUserId.codeUnitAt(i) ^ encCode.codeUnitAt(i));
    }
  ...
  String usernameCached = "";
  @override
  void initState() {
    _passwordController.text = "";
    _rePasswordController.text = "";
    loadFromCache = getUserNameFromCache();
    super.initState();
  }

  Future loadFromCache;
  Future<String> getUserNameFromCache() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final List<String> userData = (prefs.getStringList('userData') ?? null);
    usernameCached = userData[0];
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.connectionState ==
                                      ...
                                      return QrImage(
                                        ...
                                        data: encryptUserName(snapshot.data),
                                      );
                                    }
                                  }),
                            ),
